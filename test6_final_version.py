#command to activate Python virtual environment: source venv/bin/activate
#install Python packages command: pip install Pillow scikit-learn gradio scikit-image numpy
#command: python3 test6_final_version.py
#  public url: https://b09917fc7f667ba993.gradio.live
